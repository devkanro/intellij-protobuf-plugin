...
object BufBuildExcludesSchema : BufFieldSchema(
    "excludes",
    "The `excludes` key is optional, and lists directories to ignore from .proto file discovery. " +
        "Any directories added to this list are completely skipped and excluded in the module. " +
