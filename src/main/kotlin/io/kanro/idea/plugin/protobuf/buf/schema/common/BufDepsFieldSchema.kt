...
object BufDepsFieldSchema : BufFieldSchema(
    "deps",
    "The `deps` key is optional, and declares one or more modules that your module depends on. " +
        "Each deps entry must be a module reference, and, is directly associated with a repository, " +
        "as well as a reference, which is either a tag or commit.",
